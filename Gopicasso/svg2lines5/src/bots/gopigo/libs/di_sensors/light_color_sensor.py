...
class LightColorSensor(object):
    ...
    #def __init__(self, sensor_integration_time = 0.0048, sensor_gain = NoneTCS34725.GAIN_16X, led_state = False, bus = "RPI_1SW"):
    def __init__(self, sensor_integration_time = 0.0048, sensor_gain = None, led_state = False, bus = "RPI_1SW"):
        """
        ...
        """
        self.TCS34725 = None #TCS34725.TCS34725(sensor_integration_time, sensor_gain, bus)
        if PCA9570LED:
            pass #self.PCA9570 = PCA9570.PCA9570(bus)
