...
class EasyGoPiGo3(gopigo3.GoPiGo3):
    ...
    def init_light_sensor(self, port="AD1"):
        ...
        """
        return None #TODO #easysensors.LightSensor(port, self, use_mutex=self.use_mutex)
    ...
    def init_sound_sensor(self, port="AD1"):
        ...
        """
        return None #TODO #easysensors.SoundSensor(port, self, use_mutex=self.use_mutex)
    ...
    def init_loudness_sensor(self, port="AD1"):
        ...
        """
        return None #TODO #easysensors.LoudnessSensor(port, self, use_mutex=self.use_mutex)
    ...
    def init_ultrasonic_sensor(self, port="AD1"):
        ...
        """
        return None #TODO #easysensors.UltraSonicSensor(port, self, use_mutex=self.use_mutex)
    ...
    def init_buzzer(self, port="AD1"):
        ...
        """
        return None #TODO #easysensors.Buzzer(port, self, use_mutex=self.use_mutex)
    ...
    def init_led(self, port="AD1"):
        ...
        """
        return None #TODO #easysensors.Led(port, self, use_mutex=self.use_mutex)
    ...
    def init_button_sensor(self, port="AD1"):
        ...
        """
        return None #TODO #easysensors.ButtonSensor(port, self, use_mutex=self.use_mutex)
    ...
    def init_servo(self, port = "SERVO1"):
        ...
        """
        return None #TODO #easysensors.Servo(port, self, use_mutex=self.use_mutex)
    ...
    def init_dht_sensor(self, sensor_type = 0):
        ...
        """
        return None #TODO #easysensors.DHTSensor(self, sensor_type, self.use_mutex)
    ...
    def init_remote(self, port="AD1"):
        ...
        """
        return None #TODO #easysensors.Remote(port, self, self.use_mutex)
    ...
    def init_motion_sensor(self, port="AD1"):
        ...
        return None #TODO #easysensors.MotionSensor(port, self, self.use_mutex)
